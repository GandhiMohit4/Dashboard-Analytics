            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" style="width: 50px;height: 50px" src="/storage/avatars/{{ Auth::user()->avatar }}" />
                             </span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">{{ ucfirst(trans(
                ...
                <li>
                    <a href="#"><i class="fa fa-graduation-cap"></i> <span class="nav-label">Courses</span></a>
                </li>

                <li>
                    <a href="#"><i class="fa fa-line-chart"></i> <span class="nav-label">Sales</span></a>
                </li>

                <li>
                    <a href="#"><i class="fa fa-ambulance"></i> <span class="nav-label">Support</span></a>
                </li>

                <li>
                   <a href="#"><i class="fa fa-check-square-o"></i> <span class="nav-label">Agile Board</span></a>
                </li>
