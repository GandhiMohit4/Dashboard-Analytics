            ...
            <div class="row m-b-lg m-t-lg">
                <div class="col-md-6">
                    ...
                    <div class="profile-image">
                        <img src="/storage/avatars/{{ Auth::user()->avatar }}" class="img-circle circle-border m-b-md" alt="profile">
                    </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                                <h3>About {{ ucfirst(trans( $user->name )) }}</h3>
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <p class="small">
                                Send private message to {{ ucfirst(trans( $user->name )) }}
                            </p>
